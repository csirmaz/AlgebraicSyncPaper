...
\newcommand{\valdi}{\mathsf{D}'}
\newcommand{\valdii}{\mathsf{D}''}
\newcommand{\valfx}{\mathsf{F}} % File value
\newcommand{\valf}{\mathsf{F}'} % File value
\newcommand{\valff}{\mathsf{F}''} % File value
...
\newcommand{\cffa}[1]{\caaa{\valfx}{\valfx}{#1}}
...
\newcommand{\recchar}[2]{\mathcal{R}({#1}|{#2})}
...
\newtheorem{mydefaux}[myth]{Definition}
...
\theoremstyle{plain}
\newtheorem{mylem}[myth]{Lemma}
\crefname{mylem}{Lemma}{Lemmas}

\theoremstyle{plain}
\newtheorem{mycor}[myth]{Corollary}
\crefname{mycor}{Corollary}{Corollaries}

\theoremstyle{plain}
\newtheorem{myclm}[myth]{Claim}
