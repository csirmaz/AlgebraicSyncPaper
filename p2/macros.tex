...
\newcommand{\setfs}{\mathbb{F}} % Set of filesystems
...
\newcommand{\fsbroken}{\bot} % broken FS value
...
\newcommand{\workssign}{\mathbf{w}??} % TODO delete
\newcommand{\worksmsign}{\vartriangleleft}
\newcommand{\worksmeqsign}{\trianglelefteq}
\newcommand{\works}[1]{\varnothing\worksmsign:{#1}:} % TODO delete works
\newcommand{\worksc}[2]{:{#2}:\worksmeqsign:{#1}:} % TODO delete works on condition
\newcommand{\worksmstr}[2]{{#1}\worksmsign{#2}}
\newcommand{\worksmnil}[1]{{\varnothing}\worksmsign{#1}}
\newcommand{\worksm}[2]{{#1}\worksmeqsign{#2}}
