...
Sequences are also partial endofunctions on filesystems, defined only if all commands succeed.
...
is defined on, that is, it does not break.
...
\begin{mydef}[$A\indep B$: Independent commands, sequences and sets of commands]\label{def_indep}
