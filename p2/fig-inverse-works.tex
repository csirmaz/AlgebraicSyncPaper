...
\node at  (1.4-2-.1, 1.4) [left] {$C_i\in\ic$};
%%
\node at (1.1-2-.1, -2.9) [left] {$\Dom{B}$};
\draw[fill=black!5] (1.1, -2.9) ellipse (2cm and 0.8cm); %% Dom B
\node at (0-2-.1, 0) [left] {$\Img{B}=\Dom{\ibi}$};
...
\node at  (3.8,-2.2) [right] {$A_j\in\ia$};
\draw[-latex,thin] (3.5, -3.5) node[right]{$\Dom{\ia}$} -- (2.1+0.5, -2.9-0.2);
