...
The model and algorithms could be extended to the $|\setd|>1$ case, % TODO write this
...
reconcile meta-information in directories or encode them as files, % TODO write this
