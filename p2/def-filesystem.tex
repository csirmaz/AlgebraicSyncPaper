...
This assumption does not hinder the applicability of our results
(in fact, many real-life synchronizers make the same assumption),
but makes it possible to exploit a hidden symmetry in filesystem commands.

% TODO To avoid the proliferation of edge cases
% TODO In appendix TODO we describe why it can be a sensible choice
% TODO for actual synchronizers, and we also present an encoding that makes it possible
% TODO to extend our results to the $|\setd|>1$ case.
