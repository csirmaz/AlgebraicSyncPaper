...
on directly related nodes if they are
of the following form:
\begin{itemize}
\item $\caaa{x}{\vald}{\parentf{n}}\orderrel\caaa{z}{w}{n}$, and
\item $\caaa{x}{\empt}{n}\orderrel\caaa{z}{w}{\parentf{n}}$.
\end{itemize}
\end{mydef}
This relation is clearly irreflexive and asymmetric,
...
The simplicity of the definitions mean that sorting the commands
and enumerating
...
\begin{mylem}\mlabel{can_simplify}
