...
This is because from \cref{indep_prefix_combine} we know
$\worksmbx{U\cc T, U\cc S^*}{U\cc T\cc S^*}$ as $S^* \indep T$.
From $\worksmbx{S,T}{S^*}$ trivially
$\worksmbb{S,T}{S^*, T}$,
and from \cref{works_restricted} we know
$\worksmbb{U\cc S, U\cc T}{U\cc S^*, U\cc T}$.
Because $\worksmeqsign$ is transitive, combining these results
we get $\worksmbx{U\cc S,U\cc T}{U\cc T\cc S^*}$.
...
from which trivially $\worksmbx{S,T}{S^*}$.
