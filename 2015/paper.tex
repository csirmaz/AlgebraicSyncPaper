...
and use lowercase Greek letters to denote commands. % TODO but very rarely
...
$\czmv$, which sequence would therefore have the commands on
...
% TODO C.f. strict / liberal etc. reconciliation in references
